...
//
	// cout << endl;
	// cout << "Now to push 'Don't be Cruel', 'Black Magic Woman', and 'Let It Be' back into the list " << endl;
...
//
// cout << endl;
// cout << "-------------testing listDuration---------------" << endl;
// 	list->printList();
// 	int mintot = 0;
// 	int sectot = 0;
